        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalExperienceYears = table.Column<decimal>(type: "decimal(4,1)", precision: 4, scale: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobTypeAllowedTitles", x => new { x.JobTypeId, x.TitleId });
                    table.ForeignKey(
                        name: "FK_JobTypeAllowedTitles_JobTypes_JobTypeId",
                        column: x => x.JobTypeId,
                        principalTable: "JobTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobTypeAllowedTitles_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShiftApplications_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_EmployeeId_WorkDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobTypeAllowedTitles_TitleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shifts_JobTypeId_WorkDate_StartTime_EndTime",
                table: "Shifts",
                columns: new[] { "JobTypeId", "WorkDate", "StartTime", "EndTime" });
        }
